...
<Figure
  src="/diagrams/ejb-5-files.svg"
  alt="The five files required to create one EJB component"
  caption="Five files to create one UserService. All must stay in sync. Any mismatch is a runtime error found at 2am."
  label="ejb-5-files.svg"
/>
