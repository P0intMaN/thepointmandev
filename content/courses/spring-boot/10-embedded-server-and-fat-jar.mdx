...
<Figure
  src="/diagrams/fat-jar-vs-war.svg"
  alt="Comparison of old WAR-in-Tomcat model versus new JAR-with-embedded-Tomcat model"
  caption="Before: your app lived inside an external server shared with others. After: the server lives inside your JAR. One file, one command, complete isolation."
  label="fat-jar-vs-war.svg"
/>
