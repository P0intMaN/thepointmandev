...
<Figure
  src="/diagrams/auto-config-flow.svg"
  alt="Spring Boot auto-configuration conditional decision flow"
  caption="Auto-configuration is not magic — it's a conditional bean registration system. Every decision is made by a @Conditional annotation you can read and override."
  label="auto-config-flow.svg"
/>
