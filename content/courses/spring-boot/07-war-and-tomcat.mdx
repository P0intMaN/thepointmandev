...
<Figure
  src="/diagrams/dispatcher-servlet-flow.svg"
  alt="HTTP request flow through Tomcat, DispatcherServlet, and your controller"
  caption="Every request flows through Tomcat → DispatcherServlet → your @Controller. You only write the controller method — Spring handles everything else."
  label="dispatcher-servlet-flow.svg"
/>
